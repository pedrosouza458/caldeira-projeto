...
@Schema(
        description = "Dados permitidos para a atualização parcial ou total de uma empresa. Idêntico à criação, mas atualiza todos os campos fornecidos.",
        example = """
        {
          "name": "Empresa Exemplo Atualizada LTDA",
          "logo": "https://cdn.projeto.com/logos/nova-empresa.png",
          "isResident": false
        }
        """
)
